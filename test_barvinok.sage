...
parsed1 = {'variables': ['s'],
 'pieces': [{'subdomains': [{'quantifiers': {'e0': 'floor((-1 + s)/5)'},
  ...
  {'subdomains': [{'quantifiers': {'e0': 'floor((-1 + s)/5)',
      'e1': 'floor((s)/5)'},
  ...
  {'subdomains': [{'quantifiers': {}, 'linear conditions': ['s == 0']}],
   'formula': '1'}]}
...
parsed2 = {'variables': ['b1', 's'],
 'pieces': [{'subdomains': [{'quantifiers': {'e0': 'floor((-1 + b1)/3)'},
     'linear conditions': ['3 * e0 == -1 + b1',
      'b1 >= 1',
      's <= -2 + b1',
      '3 * s >= 1 + 2 * b1']}],
   'formula': '((((-2/3 + 2/3 * b1) + s) - floor((b1)/2)) - floor((b1 + s)/2))'},
  {'subdomains': [{'quantifiers': {'e0': 'floor((-1 + b1)/3)'},
