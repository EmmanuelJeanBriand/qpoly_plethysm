...
parsed2 = {'variables': ['b1', 's'], 
           'pieces': [{'domain': [
               {'quantifiers': {'e0': 'floor((-1 + b1)/3)'}, 
                'linear conditions': ['3 * e0 == -1 + b1', 'b1 >= 1', 's <= -2 + b1','3 * s >= 1 + 2 * b1']
                }], 
                      ...
                      {'domain': [{'quantifiers': {'e0': 'floor((-1 + b1)/3)', 'e1': 'floor((b1)/3)', 
                                                   'e2': 'floor((-2 + b1)/3)'}, 
                                   'linear conditions': ['3 * e2 == -2 + b1', '3 * s >= 2 * b1', 
                                                         's <= -2 + b1', '3 * e0 >= -3 + b1', 
                                                         '3 * e0 <= -2 + b1', '3 * e1 <= -1 + b1', 
                                                         '3 * e1 >= -2 + b1']
                                  }],
                      ...
                      {'domain': [{'quantifiers': {'e0': 'floor((-1 + b1)/3)', 'e1': 'floor((-2 + b1)/3)',
                                  ...
                                  {'quantifiers': {'e0': 'floor((-1 + b1)/3)', 'e1': 'floor((-2 + b1)/3)',
                                                   'e2': 'floor((b1)/3)'}, 
                                   'linear conditions': ['3 * e2 == b1', 'b1 >= 1', 's >= b1', 
                                                         '3 * e0 >= -3 + b1', '3 * e0 <= -2 + b1', 
                                                         '3 * e1 >= -4 + b1', '3 * e1 <= -3 + b1']
                                  }], 
...
## EX2.  Outpout of parse
##------------------
parsed1 = {'variables': ['s'],
           'pieces': [{'domain': [
                         {'quantifiers': {'e0': 'floor((-1 + s)/5)'}, 
                      ...
                      {'domain': [
                          {'quantifiers': {'e0': 'floor((-1 + s)/5)', 'e1': 'floor((s)/5)'}, 
                           'linear conditions': ['5 * e1 == s', 's >= 5', '5 * e0 <= -2 + s', '5 * e0 >= -5 + s']}], 
